...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.error) {
    if (req.query.error == 'access_denied') {
      ...
      console.log(this.error(new AuthorizationError(req.query.error_description, req.query.error, req.query.error_uri)))
  ...
  if (req.query && req.query.code) {
    ...
    function loaded(err, ok, state) {
      console.log("passport-start 82: "+ err)
      console.log("passport-start 83: "+ ok)
      console.log("passport-start 84: "+ state)
      ...
      oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: callbackURL, client_id: meta.clientID, client_secret: meta.clientSecret }, function(err, accessToken, refreshToken, params) {
